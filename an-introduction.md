...
不同阶段智能体概念模型E3，故事线的实现，规格，载体存在差异，这些载体为智能载体。不同能力智能体具有不同的概念能力，比如高阶智能体可以使用概念扩展环境增强环境交互能力。对于智能载体能力评估的参考模型为智能评估模型。使用智能评估模型定义的智能体等级为智能基线。评估模型定义的任务为评估任务。如具有和环境交互，主观产生动作直接影响环境演化的智能体为交互智能体，面向交互任务的智能体评估模型为交互评估模型。交互评估模型通过故事线价值对齐实现的评估评估模型为价值评估模型。如使用神经网络进行目标检测的任务，这一类无主观行为的智能任务为分离神经任务，多个分离任务的可以复合为一个复合神经任务。智能体可能承载多种神经任务，智能体的信息处理系统的不同故事线的任务模型抽象为大脑任务Brain Task。
